...
// NewAccountsRep creates a new instance of AccountsRep. It also registers the testing.TB interface on the mock and a cleanup function to assert the mocks expectations.
func NewAccountsRep(t testing.TB) *AccountsRep {
	mock := &AccountsRep{}
	mock.Mock.Test(t)
