...
// NewCategoriesRep creates a new instance of CategoriesRep. It also registers the testing.TB interface on the mock and a cleanup function to assert the mocks expectations.
func NewCategoriesRep(t testing.TB) *CategoriesRep {
	mock := &CategoriesRep{}
	mock.Mock.Test(t)
