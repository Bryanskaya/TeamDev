...
// NewStepsRep creates a new instance of StepsRep. It also registers the testing.TB interface on the mock and a cleanup function to assert the mocks expectations.
func NewStepsRep(t testing.TB) *StepsRep {
	mock := &StepsRep{}
	mock.Mock.Test(t)
