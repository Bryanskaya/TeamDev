...
// NewIngredientsRep creates a new instance of IngredientsRep. It also registers the testing.TB interface on the mock and a cleanup function to assert the mocks expectations.
func NewIngredientsRep(t testing.TB) *IngredientsRep {
	mock := &IngredientsRep{}
	mock.Mock.Test(t)
